    ...
    return {
      ...
      onChange: function onChange(valueOrEvent) {
        if (valueOrEvent != null) {
          var _value = _typeof(valueOrEvent) === 'object' && 'target' in valueOrEvent ? valueOrEvent.target.value : valueOrEvent;

          var valuesNew = _objectSpread({}, values, _defineProperty({}, name, _value));
